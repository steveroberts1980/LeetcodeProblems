...
def visible_nodes(root):
  ...
  # approach
  # Looking from the left or right, we may see different nodes
  # However, we will always see the same number of nodes
  # Therefore, this is just a matter of finding the max depth 
  # of the tree

  # The most straightforward way to do this is with a recursive function
  # We will pass in a depth counter and return the max depth from 
  # that function
